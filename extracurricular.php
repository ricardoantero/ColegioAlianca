...
<?php include('assets/master/menuTopo.php'); ?>
  <main class="main">
 <!-- Page Title -->
 <picture class="banner-desktop"> <source media="(max-width: 575px)" srcset="assets/img/banner_extracurricular_site_mobile.jpg">
    <img class="banner-desktop" src="assets/img/banner_extracurricular_site_desktop.jpg" alt="Colégio Aliança" data-aos="fade-in">
